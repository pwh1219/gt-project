...
<script>
    ...
    $(function () {
        $('#ff').form('load', {
            fatherDirect: direct.directId,
            name: direct.directName,
            directUrl: '',
            directRoot: '1',
            directDelete: '1'
        });
    ...
    function save() {
        $('#ff').form('submit', {
            url: '${proPath}/directory/addSon.mvc',
...
<form id="ff" method="post">
    <input type="hidden" name="fatherDirect">
    <input type="hidden" name="directRoot">
