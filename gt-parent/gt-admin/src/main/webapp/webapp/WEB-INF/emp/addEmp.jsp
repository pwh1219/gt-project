...
<form id="ff" method="post">
    <div>
        <div id="d1">
            ...
            <input type="text" class="easyui-validatebox" data-options="required:true" id="empAccount" name="empAccount" style="height: 24px">
        </div>

        <div id="d2">
            <div style="float: left;width: 96px">姓名：</div>
            <input type="text"  class="easyui-validatebox" data-options="required:true" id="empName" name="empName" style="height: 24px">
        </div>
